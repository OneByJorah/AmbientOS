...
function startApp(options = {}) {
  ...
  server.listen(state.cfg.port, state.cfg.host || '127.0.0.1', () => {
    console.log(`wallpaper:  http://${state.cfg.host || '127.0.0.1'}:${state.cfg.port}`);
    console.log(`settings:   http://${state.cfg.host || '127.0.0.1'}:${state.cfg.port}/settings.html`);
  });
